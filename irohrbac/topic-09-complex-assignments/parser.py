...
def parse_assignment_expression(tokens):
    ...
    if tokens[0]["tag"] == "=":
        ...
        # Ensure position is propagated from the left-hand side
        line = tokens[0].get("line", "unknown")
        # print(f"DEBUG: Propagating line {line} to assignment node")
        return {"tag": "assign", "target": left, "value": right, "position": line}, tokens
